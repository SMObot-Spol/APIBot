...
const { Client, Events, GatewayIntentBits, Collection, REST, Routes, codeBlock, time, hyperlink} = require('discord.js');
...
(async () => {
    ...
    async function getToken(){
        const res = await axios.get('https://control.sparkedhost.us/api/client/servers/29562251/websocket', {
    headers: {
